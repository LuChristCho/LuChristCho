...
BrowserFS.configure({ fs: "IndexedDB", options: {} }, function (err) {
    ...
    const commands = {
        "welcome": "[[;#0ff;]Hi:) Welcome to My GitHub Account!]",
        "name": "[[;#0ff;]Full Name: Masih Sheikhi]",
        "field": "[[;#0ff;]Field: Materials Science and Engineering]",
        "interests": "[[;#0ff;]Interests: AI, Data, Frontend, Economics, Physics and Musics:)]",
